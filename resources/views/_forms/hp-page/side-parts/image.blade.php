...
@endpush
<div class="page-element sortable-item element-image side-contents-image" data-name="<?php echo $element->getName()?>" data-type="<?php echo $element->getType()?>" data-type-name="<?php echo $element->getTypeName()?>" data-is-unique="<?php echo $element->isUnique()?>">
		...
		<div class="item-list">
			<div class="select-image">
				...
				<div class="is-require input-img-title">
					...
					<?php $element->form('image_title')?><span class="input-count"></span>
					<div class="errors"></div>
				</div>
			</div>
				...
				<div class="input-img-wrap" style="display:none;">
					...
					<div class="search-btn link-wrapper">
						...
						<ul>
							...
							<div class="is-hide select-page"><?php $element->form('link_page_id')?></div>
						</ul>
						<div class="errors"></div>
					</div>
					<dl class="link-wrapper">
						...
						<dd>
							<?php $element->form('link_url')?><span class="input-count link-url-count"></span>
							<div class="errors"></div>
						</dd>
					</dl>
					<dl class="link-wrapper">
