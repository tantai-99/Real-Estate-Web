...
<div class="page-element-header">
    ...
    <?php $element->simpleHidden('column_sort')?>
    <?php $element->simpleHidden('display_flg')?>
	...
	<div class="page-element-body">
        ...
        <table class="table-search freeword-table">
            <?php foreach ($element->getElements() as $name  => $el) : ?>
                <?php if (get_class($el) == "Library\Custom\Form\Element\Hidden") continue; ?>
                <tr>
