<div class="page-element-header">
  <h3><span><?php echo $element->getTitle(); ?></span></h3>
  <?php $element->form('parts_type_code')?>
  <?php $element->form('sort')?>
  <?php $element->form('column_sort')?>
  ...
  <ul class="page-element-menu">
    ...
    <?php if ($element->getValue('parts_type_code') == \App\Repositories\HpMainParts\HpMainPartsRepository::PARTS_SET_LINK_AUTO):?>
    <li class="pull">
