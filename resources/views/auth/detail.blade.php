	...
	<div class="main-contents info-detail">
		...
		<div class="main-contents-body">
			...
			<?php if($view->information->display_type_code == config('constants.information_display_type_code.URL')) : ?>
				<a href="<?php echo $view->information->url; ?>" target="_blank"><p><?php echo $view->information->url; ?></p></a>
			</div>
			...
			<div class="info-file">
				...
				<?php foreach($view->params['name'] as $key => $val) : ?>
						...
						<?php if($view->params['extension_check'][$key] == 'pdf'): ?> i-f-pdf <?php endif;?>" 
						href="/auth/download/?file_id=<?php echo h($view->params['file_id'][$key]) ?>">
			...
			<div class="info-file">
				<a class="
					...
					<?php if($view->params['extension_check'] == 'pdf'): ?> i-f-pdf <?php endif;?>" 
				href="/auth/download/?id=<?php echo $view->information->id; ?>"><p><?php echo $view->params['file_name'] ?></p></a>
			</div>
			<?php endif; ?>

			<div class="btns">
				<?php if(isset($view->param['back']) && $view->param['back'] == "top") : ?>
				<a href="/auth/login" class="btn-t-gray">戻る</a>
				<?php else : ?>
				<a href="#" onclick="history.back();" class="btn-t-gray">戻る</a>
				<?php endif;?>
			</div>
		</div>
	</div>
