...
$(function(){
    ...
    app.modal.popup = function (options) {
        ...
        if (options.closeButton !== false) {
            ...
            $('body').on('click', '.modal-fdp-cancel-btns > a', function(e){
                e.preventDefault();
                $("#peripheral").prop('checked', false);
                modal.close(false);
            });
            // 13012 fix area link click
            $('body').on('click', '.modal-fdp-btns > a', function(e){
                e.preventDefault();
    ...
    contactFdp = function() {
        ...
        this.getForm = function(){
            ...
            '<div class="area"><div class="left"><div class="left-content"><div class="text">ご提供する「エリア情報」</div>' +
            ...
            '<br><p>ぜひとも一緒にご覧いただき、物件選びの参考にしてください。</p></div></div></div>' +
            '<div class="right"><div class="left-content"><img class="contact-img" src="/pc/imgs/fdp/contact-fdp.png">' +
            '<div class="contact-text">「エリア情報」のサンプル</div></div></div></div>' +
            ...
            $('.close-button-modal-square').on('click', function() {
                modal.close(false);
            });
        }
    };    
