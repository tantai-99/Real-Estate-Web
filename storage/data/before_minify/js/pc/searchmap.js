    ...
    this.userevent = new function () {
        ...
        this.init = function () {
            ...
            $('.btn__gnav_toggle').on('click', function(){
                ...
                // snsボタンは使いまわす
                if($('.page-header-liquid').hasClass('close')){
                    $('.page-header-liquid').append($('.page-header-top .inner .header-sns'));
                }else{
                    $('.page-header-top .inner').append( $('.page-header-liquid .header-sns'));
                }
