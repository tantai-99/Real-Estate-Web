    ...
    this.userevent = new function () {
        ...
        this.init = function () {
            ...
            $('.btn__gnav_toggle').on('click', function(){
                ...
                $('.page-header-liquid').css({
                    'height': ''
                });
                var mapsHeaderHeight	= $('.maps-header').outerHeight( true ) ;
                var pageHeaderLiquid	= 70 ;
                if ( $('.btn__gnav_toggle').hasClass('open') )
                {
                	mapsHeaderHeight	+= 45				;
                	pageHeaderLiquid	 = mapsHeaderHeight	;
                }
                $('.page-header-liquid').css({
                    'height': pageHeaderLiquid + 'px'
                });
                $('.contents-map').css({
