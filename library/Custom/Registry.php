...
class Registry extends ArrayObject
{
     ...
     * @var string
     */
    private static $_registryClassName = 'Library\Custom\Registry';
     ...
     * @return void
     */
    public static function setClassName($registryClassName = 'Library\Custom\Registry')
    {
        if (self::$_registry !== null) {
            throw new \Exception('Registry is already initialized');
        }
    ...
    public function __construct($array = array(), $flags = self::ARRAY_AS_PROPS)
    {
