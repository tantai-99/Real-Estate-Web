...
class DetailPanorama extends _AbstractGateway {
    ...
    public function run() {
        ...
        $url .= $this->addParam(ApiGateway::KEY_PANORAMA, 1);

        if(!empty($this->view->request->parse['query'])) {
            $url .= "&" . $this->view->request->parse['query'];
        }
