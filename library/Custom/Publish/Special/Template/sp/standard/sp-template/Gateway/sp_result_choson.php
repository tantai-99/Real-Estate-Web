...
class SpResultChoson extends _AbstractGateway {
    ...
    public function run() {
        ...
        // save condition
        $params = [
            SearchCondition::STATION => $this->request->getChosonFromUrl(4),
        ...
        $url .= $this->addParam(ApiGateway::KEY_STATION, $this->request->getChosonFromUrl(4));
