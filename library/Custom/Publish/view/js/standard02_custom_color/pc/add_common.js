...
var navSize = $('nav.gnav ul').find('li').size();
$('nav.gnav ul').addClass('nav-count' + navSize);
$('nav.gnav ul li').each(function(){
    $(this).find('a').wrapInner('<span>');
    $(this).prepend('<b><span></span></b>')
    // var itemSize = $(this).text().length;
    // if(itemSize > 11){
    //     $(this).addClass('fs-small');
    // }
...
// asset list design =====================================================
    //fake pjax
    $('body.top').delay(200).animate({opacity:1},500);
    // fit image
    ...
    // api map page =====================================================
    if($('.maps-header').length){
        $('body').addClass('api-map')
    }
    // wrap form table =====================================================
    /*
