        ...
        <form action="<?php echo '/'.$view->base['filename'].'/edit/'?>" method="post">
          ...
          <?php endif;?>
            ...
            <tr>
              ...
              <td><?php echo( htmlspecialchars($item['item_value']) ) ?><?php if(!empty($item['item_value'])) : ?><?php echo $contact->getItemUnitWord($item['item_key']); ?><?php endif; ?>
          ...
          <?php if( in_array($hp['theme_name'], array('standard02_custom_color','natural02_custom_color','simple02_custom_color')) ) : ?>
            <input type="submit" value="入力画面に戻る" name="back" class="btn-lv4">
            <input type="submit" value="送信する" name="send" class="btn-lv3"></p>
          <?php else :?>
            <input type="submit" value="入力画面に戻る" name="back" class="btn-lv2">
            <input type="submit" value="送信する" name="send" class="btn-lv1"></p>
          <?php endif; ?>
        </form>
      </div>
