...
$themeKoma='';
if($dataKoma){
	$themeKoma=file_get_contents(APPLICATION_PATH.'/common/pc/themeKoma/{theme_koma}');
	if($themeKoma){
...
$html = str_replace('{rows}',$view->element->getValue(EstateKoma::PC_ROWS),$html);
$html = str_replace('{columns}',$view->element->getValue(EstateKoma::PC_COLUMNS),$html);
