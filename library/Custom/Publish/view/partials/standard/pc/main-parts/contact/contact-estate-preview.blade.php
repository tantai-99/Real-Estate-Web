        ...
        <form action="#" method="">
          <table class="element-table7">
            <tr>
              <th class="col1">選択</th>
              <th class="col2">画像</th>
              <th class="col3">駅路線 / 所在地</th>
              <th class="col4">徒歩</th>
              <th class="col5">賃料 / <br>
                管理費等</th>
              <th class="col6">敷/保証/礼</th>
              <th class="col7">間取り/面積</th>
              <th class="col8">物件種目 / 築年月</th>
            </tr>
            <tr>
              <td class="js-clickable-area cell-checkbox">
                <input type="checkbox" name="hoge" value="1">
              </td>
              <td>
              <img src="/images/page-edit/ph_recommend2.jpg" alt="">
              </td>
              <td class="col2">
                御茶ノ水/ＪＲ総武・中央緩行線<br>
                千代田区神田駿河台２丁目
            ...
            <tr>
              ...
              <td>
                ...
                <?php elseif ($itemKey=='peripheral') :?>
                  <ul>
                    <li><input type="checkbox" name="<?php echo htmlspecialchars($itemKey)?>[]" value="" id="<?php echo htmlspecialchars($itemKey)?>"><label for="<?php echo htmlspecialchars($itemKey)?>">エリア情報の提供を希望する</label><br><label>（ご提供する「エリア情報」の詳細は<a href="#" class="js-fdp-modal">こちら</a>をご覧ください）</label></li>
                  </ul>
                <?php // 連絡先 ?>
                    ...
                    <dl class="form-address">
                      ...
                      <dd>
                        <?php if($val['key'] === 'person_tel'): ?>
                          ...
                          <?php for($i=1; $i<=3; $i++ ): ?>
                            <input type="text" name="" class="input-tx3 mr0" value="">
                            <?php if($i !== 3): ?>
                              <span>-</span>
                            <?php endif; ?>
                          <?php endfor; ?>
          ...
          <?php echo $view->partial('main-parts/contact/_contact-privacypolicy.blade.php', 
            ...
            <p class="tac btn-confirm"><input type="submit" value="上記にご同意の上 確認画面へ進む" name="next" class="btn-lv3" disabled></p>
        </form>
      </div>
        </section>