...
$device = 'pc';
$scriptPath = $view->getScriptPath('script/sidenavscript.blade.php');
...
// gmo server
    ...
    echo '<?php $isTopOriginal = '.$view->isTopOriginal.' ;?>';
    echo '<?php $sidebarOtherLinkTitle = '.$sidebarOtherLinkTitle.' ;?>';
