                            ...
                            <?php $apiElement = $apiContactForm->getElement($itemKey."_sub");?>
                                <?php if(!is_null($apiElement)): ?>
                                    ...
                                    <ul class="list-radio">
                                        <?php $no=1; foreach($options as $option): ?>
                                        <?php if(empty($option))continue; ?>
                                        <li><input type="radio" name=<?php echo $itemKey."_sub" ?> <?php if($option === '坪'): ?>checked="checked"<?php endif; ?> value=<?php echo $no ?> id=<?php echo $itemKey."_sub" ?>><label for="<?php echo $itemKey."_sub" ?>"><?php echo $option?></label></li>
                                        <?php $no++; endforeach ?>
                                    </ul>
                                <?php endif ?>
                        </div>
