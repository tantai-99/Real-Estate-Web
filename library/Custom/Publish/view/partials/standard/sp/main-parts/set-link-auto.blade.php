...
$isSimpleCustom = 0;
if (MThemeRepository::getThemeName($view->hp->theme_id) == 'simple02_custom_color') {
    $isSimpleCustom = 1;
}
if ($isPreview):
        ...
        <section class="element-auto-link link-menu">
            <ul>
                ...
                <li><?php $url = $view->hpLink($large['link_id']);?>
                    <a href="<?php echo $url ?>"><?php echo $large['title'] ?></a>
                </li>
                <?php endforeach; ?>
            </ul>
        </section>
    ...
    <?php foreach ($view->element->elements->getSubForms() as $item): ?>
        ...
        <section>
            <div class="element-auto-link element-auto-line element-auto-lead">
    ...
    <?php if(count($larges) > 0):
        foreach ($larges as $key => $large):
            ...
            $smallList = [];
            // if (count($smalls) > 0): ?>
            <section class="block-large-category">
                <div class="block-large-heading-dl">
                    <h3 class="heading-lv2"><?php echo $large['title'] ?></h3>
                    <dl>
                        <dt class="block-open"></dt>
                    </dl>
                </div>
                <div class="large-list element-block-large">
                    <ul>
                    ...
                    <div class="pick-up element-pick">
                        <ul>
                        ...
                        if (count($smallList) > 0):
                            ...
                            ?>
                            <li class="link-pick-up"><a href="<?php echo $urlActicle ?>"><?php echo $acticle[$random]['title'] ?></a></li>
                            <?php endif;
                        endif; ?>
                        </ul>
                    </div>
                    <div class="btn-link-category">
                    <p class="link-category">
                        <a href="<?php echo $url ?>"><span class="link-title"><?php echo $large['title'] ?></span><br/><span class="link"> 一覧ページ</span></a>
                    </p>
                    </div>
                </div>
            </section>
    ...
    if (in_array($pageTypyCode, $largeCategory)):
        ...
        <section>
            <div class="element-auto-link">
                <div class="small-category element-small-category">
        ...
        <?php if (count($smalls) > 0):
            ...
            ?>
            <section class="element-auto-link block-small-category element-block-small">
                <div class="block-small-heading-dl">
                ...
                <div class="small-list">
                    ...
                    ?>
                    <li>
                        <a href="<?php echo $urlActicle ?>"><?php echo $acticle['title'] ?></a>
                    </li>
                    <?php endforeach;
                    endif; ?>
                    </ul>
                    <div class="btn-link-category">
                        <p class="link-category">
                            <a href="<?php echo $url ?>"><span class="link-title"><?php echo $small['title'] ?></span><br/><span class="link"> 一覧ページ</span></a>
                        </p>
                    </div>
                </div>
            </section>
        ...
        <section>
            <div class="element-auto-link link-other-category">
                <?php if ($isSimpleCustom): ?>
                <div class="link-other-category-dl">
                    <h3>他のカテゴリーの記事も見てみる</h3>
                    <dl><dt class="block-open"></dt></dl>
                </div>
                <?php else: ?>
                <h3>他のカテゴリーの記事も見てみる</h3>
                <?php endif ?>
    ...
    if (in_array($pageTypyCode, $table->getPageArticleByCategory(HpPageRepository::CATEGORY_SMALL))):
        foreach ($view->element->elements->getSubForms() as $item):
            if ($item->getValue('lead')): ?>
            <section>
                <div class="element-auto-link small-auto-link element-small-lead">
                    <div><?php echo $item->getValue('lead') ?></div>
                </div>
            </section>
            <?php endif;
        endforeach; ?>
        ...
        if (count($acticles) > 0): ?>
        <div class="element-auto-link element-small-article">
        ...
        ?>
            ...
            <div class="element-text-small-article">
                ...
                <div class="link-category"><a href="<?php echo $url ?>">記事を読む</a></div>
            </div>
            </div>
            <hr>
        <?php endforeach; ?>
...
<?php else:
    if ($pageTypyCode == HpPageRepository::TYPE_USEFUL_REAL_ESTATE_INFORMATION):
        ...
        <section class="element-auto-link link-menu">
            <ul>
                ...
                <li><a href="#link_<?php echo $key ?>"><?php echo $page[\'title\'] ?></a>
                </li>
                <?php endforeach; ?>
            </ul>
        </section>
        ...
        if(count($pages > 0)):
            foreach ($pages as $key => $page):
                ...
                $smallList = [];
                // if (count($smalls) > 0): ?>
                <section class="block-large-category" id="link_<?php echo $key; ?>">
                    <div class="block-large-heading-dl">
                    ...
                    <div class="btn-link-category">
                    <p class="link-category">
                        <a href="<?php echo $viewHelper->hpLink($page[\'link_id\']) ?>"><span class="link-title"><?php echo $page[\'title\'] ?></span><br/><span class="link"> 一覧ページ</span></a>
                    </p>
                    </div>
                </div>
                </section>
    ...
    <?php if (in_array($pageTypyCode, $largeCategory)): 
            ...
            <div class="element-auto-link element-small-category">
                <div class="small-category">
                    ...
                    foreach ($smalls as $key => $small):
                        $urlSmall = $viewHelper->hpLink($small[\'link_id\']);
                    ?>
                    <li><a href="#small_<?php echo $key; ?>"><?php echo $small[\'title\'] ?></a></li>
                    <?php endforeach; ?>';
                    ?>
                    </ul>
                </div>
        ...
        <?php echo '<?php if (count($smalls) > 0):
            ...
            ?>
            <section class="element-auto-link block-small-category element-block-small" id="small_<?php echo $key; ?>">
                <div class="block-small-heading-dl">
                    <h3 class="heading-lv2"><?php echo $small[\'title\'] ?></h3>
                    <dl>
                        <dt class="block-open"></dt>
                ...
                <div class="small-list">
                    ...
                    <div class="btn-link-category">
                        <p class="link-category">
                            <a href="<?php echo $viewHelper->hpLink($small[\'link_id\']) ?>"><span class="link-title"><?php echo $small[\'title\'] ?></span><br/><span class="link"> 一覧ページ</span></a>
                        </p>
                    </div>
                </div>
            </section>
       ...
       <section>
            <div class="element-auto-link link-other-category">
                ...
                if (isset($randomNumber)):
                    foreach ($randomNumber as $number): ?>
                    <ul class="link-other"><li>
                        <?php echo $viewHelper->getPageByIdPage($acticleWithoutCategory[$number][\'parent_page_id\'])[\'title\']; ?></li>
                    <li>
                    ...
                    foreach ($acticleWithoutCategory as $key => $acticleWithout): ?>
                    <ul class="link-other"><li><?php echo $viewHelper->getPageByIdPage($acticleWithout[\'parent_page_id\'])[\'title\'] ?></li>
                    <li>
        ...
        <section class="element-large-category">
            ...
            <div class="element-auto-link">
                ...
                <li class="large-link">
                    <a href="<?php echo $url ?>"><span class="link"></span><?php echo $menu[\'title\'] ?></a>
                </li>
                    <?php else : ?>
                <li class="large-title">
    ...
    <?php if (in_array($pageTypyCode, $table->getPageArticleByCategory(HpPageRepository::CATEGORY_SMALL))):
        ...
        ?>
            ...
            <div class="element-image-small-article">
                ...
                <?php else: ?>
                <a href="<?php echo $url; ?>"><img src="/sp/imgs/img_nophoto_160.png" alt="img nophoto"></a>
                <?php endif; ?>
            </div>
            <div class="element-text-small-article">
                <?php $content = null;
        ...
        <?php echo '<?php $pageMenus = $viewHelper->getChildByPageTypeCode($viewHelper->getLargesCategory());
        if(count($pageMenus) > 1): ?>'; ?>
        <section class="element-large-category">
            <h3><?php 
            echo '<?php $usefllRealEstate = $viewHelper->getChildByPageTypeCode([' . HpPageRepository::TYPE_USEFUL_REAL_ESTATE_INFORMATION . ']);
