            ...
            <tr>
              <td>
                ...
                <?php elseif($item['type']=='text'): ?>
                  <input type="text" name="<?php echo htmlspecialchars($item['item_key']) ?>" class="input-tx1 <?php echo htmlspecialchars($item['item_key']) ?>-input <?php if($contact->getItemUnitWord($item['item_key']) !== null) : ?>w-90<?php endif; ?>" value="<?php echo htmlspecialchars($item['item_value']) ?>" maxlength="<?php echo htmlspecialchars($item['maxlength']) ?>" validatelength="<?php echo htmlspecialchars($item['validatelength']) ?>" label="<?php echo htmlspecialchars($item['label']) ?>"> <span><?php echo $contact->getItemUnitWord($item['item_key']); ?></span>
