...
if ($setting) {
    ...
    if(count($options) === 1){
        ...
        $option = '<input type="hidden" class="sideparts-search-type search-type" value="'.$optVal.'">';
        $option.= '<p class="side-others-tx" style="margin-bottom:0px;">'.$optTxt.'</p>';
        switch($optVal) {
            case 'chintai':
    ...
    <section>
		...
		<div>
            <?php if(count($options) === 1): ?>
                <?php echo $option; ?>
            <?php else : ?>
                <select class="sideparts-search-type search-type">
                    <?php echo $option; ?>
                </select>
            <?php endif ?>
		</div>
        ...
        <div class="side-others-tx">
            <ul class="inline">
                ...
                <li class="ml10">件</li>
                <li><button class="sideparts-btn-search-top btn-search-top">検索</button></li>
            </ul>
        </div>
    </section>
</div>
