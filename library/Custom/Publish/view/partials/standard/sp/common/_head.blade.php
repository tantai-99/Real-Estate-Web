...
<head>
    ...
    <link rel="apple-touch-icon"
        <?php if ($view->isPreview): ?>
            href="<?php echo url('/image/webclip', ['id' => $view->hp->webclip]); ?><?php // echo $view->url(array('controller' => 'image', 'action' => 'webclip', 'id' => $view->hp->webclip)); ?>"
        <?php else : ?>
    ...
    <link rel="stylesheet" href="<?php $view->src('css/color-'.h($view->color->name).'.css'); ?>"/>
