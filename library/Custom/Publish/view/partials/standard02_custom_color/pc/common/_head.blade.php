...
?>
    ...
    <?php if ($view->isPreview): ?>
        ...
        <style>
        @font-face { 
            font-family: 'athm-std2'; 
            src: url("<?php $view->src('fonts/athm-std2.ttf'); ?>") format("truetype"), 
            url("<?php $view->src('fonts/athm-std2.woff'); ?>") format("woff"), 
            url("<?php $view->src('fonts/athm-std2.svg'); ?>") format("svg"); 
