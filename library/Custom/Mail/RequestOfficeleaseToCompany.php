...
class RequestOfficeleaseToCompany  extends MailAbstract
{

    const TEMPLATE_FILE_NAME = 'request_officelease_mail_to_company';
    const SUBJECT            = '【物件リクエスト】アットホーム（貴店ホームページ）より（問合せ）';
