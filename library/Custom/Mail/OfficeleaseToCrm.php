...
class OfficeleaseToCrm extends Estate
{

    const TEMPLATE_FILE_NAME = 'officelease_mail_to_crm';
    const SUBJECT            = '貴店ホームページからの事業用賃貸物件のお問合せ　アットホーム　ホームページ作成ツール  
';
    const FROM               = 'dummy-to-crm@dummy.com';
    const ESTATE_CATEGORY    = 'officelease';
    ...
    protected $bukkenCode = array(
        ...
        Estate::PROPERTY_USING_AREA       ,     //使用部分面積
    );
	// メールに記載するお問い合わせ項目の順番
