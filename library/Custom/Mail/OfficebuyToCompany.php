...
class OfficebuyToCompany  extends Estate
{

    const TEMPLATE_FILE_NAME = 'officebuy_mail_to_company';
    const SUBJECT            = '貴店ホームページからの事業用売買物件のお問合せ　アットホーム　ホームページ作成ツール  
';
    const FROM               = 'dummy@dummy.com';
    const ESTATE_CATEGORY    = 'officebuy';
