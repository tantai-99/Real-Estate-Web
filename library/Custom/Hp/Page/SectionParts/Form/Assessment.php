...
class Assessment extends AbstractForm {

	public function getItemCodes() {
		return \App::make(HpContactPartsRepositoryInterface::class)->getAssessmentItemCodes();
	}

	protected $_form_title = '査定依頼';
	...
	protected $_defaultRequiredType = array(
			...
			HpContactPartsRepository::PERSON_ADDRESS			=> HpContactPartsRepository::REQUIREDTYPE_OPTION,
			HpContactPartsRepository::PERSON_GENDER				=> HpContactPartsRepository::REQUIREDTYPE_HIDDEN,
			HpContactPartsRepository::PERSON_AGE				=> HpContactPartsRepository::REQUIREDTYPE_HIDDEN,
			...
			HpContactPartsRepository::NOTE						=> HpContactPartsRepository::REQUIREDTYPE_OPTION,
	...
	protected $_onlyRequiredRequiredType = array(
			...
			HpContactPartsRepository::PROPERTY_TYPE,
			HpContactPartsRepository::PROPERTY_ADDRESS,
			HpContactPartsRepository::PROPERTY_STATE,
			HpContactPartsRepository::PROPERTY_CELL_REASON
	);
}