...
class Livingbuy extends AbstractForm {

	public function getItemCodes() {
		return \App::make(HpContactPartsRepositoryInterface::class)->getLivingBuyItemCodes();
	}

	protected $_form_title = '居住用売買物件';

	protected $_form_subject_choice_count = 11;
