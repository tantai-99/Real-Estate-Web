...
class RequestLivinglease extends AbstractForm {

	public function getItemCodes() {
		return \App::make(HpContactPartsRepositoryInterface::class)->getRequestLivingLeaseItemCodes();
	}

	protected $_form_title = '居住用賃貸物件';

	// protected $_form_subject_preset = array(
	protected $_form_subject_placeholder = array(
			'〇〇マンションの物件を紹介して欲しい',
			'〇〇大学の近くでおすすめの物件を紹介して欲しい',
			'初期費用が抑えられるおすすめ物件を紹介して欲しい',
	);
