...
class RequestOfficelease extends AbstractForm {

	public function getItemCodes() {
		return \App::make(HpContactPartsRepositoryInterface::class)->getRequestOfficeLeaseItemCodes();
	}
	...
	protected $_form_subject_placeholder = array(
			'〇〇ビルの貸オフィスの物件を紹介して欲しい',
			'〇〇駅の〇〇出口側にあるおすすめ物件を紹介して欲しい',
			'〇〇用の居抜き物件を紹介して欲しい',
	);
