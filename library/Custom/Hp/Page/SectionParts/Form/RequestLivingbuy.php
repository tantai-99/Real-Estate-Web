...
class RequestLivingbuy extends AbstractForm {

	public function getItemCodes() {
		return \App::make(HpContactPartsRepositoryInterface::class)->getRequestLivingBuyItemCodes();
	}
	...
	protected $_form_subject_placeholder = array(
			'〇〇マンションの物件を紹介して欲しい',
			'〇〇小学校区内のおすすめ物件を紹介して欲しい',
			'リノベーションが可能なおすすめ物件を紹介して欲しい',
	);
