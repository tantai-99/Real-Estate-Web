...
class Document extends AbstractForm {
	...
	public function getItemCodes() {
		return \App::make(HpContactPartsRepositoryInterface::class)->getDocumentItemCodes();
	}

	protected $_form_title = '資料請求';
	...
	protected $_defaultRequiredType = array(
			HpContactPartsRepository::SUBJECT					=> HpContactPartsRepository::REQUIREDTYPE_OPTION,
			...
			HpContactPartsRepository::PERSON_TIME_OF_CONNECTION	=> HpContactPartsRepository::REQUIREDTYPE_HIDDEN,
