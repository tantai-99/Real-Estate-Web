    ...
    <section class="element-checklist">
        ...
        <section>
            <h3 class="heading-lv2-1column">気になる物件を50件まで登録できます。</h3>
            ...
            <div class="list-fav parking" style="display: none">
                <div class="element">
                    <p class="element-tx">該当の物件がありません。
                    </p>
                </div>
            ...
            <div class="list-fav office" style="display: none">
                <div class="element">
                    <p class="element-tx">該当の物件がありません。
                    </p>
                </div>
            ...
            <div class="list-fav others" style="display: none">
                <div class="element">
                    <p class="element-tx">該当の物件がありません。
                    </p>
                </div>
            ...
            <div class="list-fav mansion" style="display: none">
                <div class="element">
                    <p class="element-tx">該当の物件がありません。
                    </p>
                </div>
            ...
            <div class="list-fav house" style="display: none">
                <div class="element">
                    <p class="element-tx">該当の物件がありません。
                    </p>
                </div>
            ...
            <div class="list-fav land" style="display: none">
                <div class="element">
                    <p class="element-tx">該当の物件がありません。
                    </p>
                </div>
            ...
            <div class="list-fav business" style="display: none">
                <div class="element">
                    <p class="element-tx">該当の物件がありません。
                    </p>
                </div>
            ...
            <div class="btn-checklist-action">
                <ul>
                    <li class="btn-delete"><a href="#">削除</a></li>
