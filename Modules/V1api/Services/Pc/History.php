...
class History extends Services\AbstractElementService
{
			...
			Datas $datas)
	{
		...
		$doc = $this->getTemplateDoc("/history/content.tpl");
        ...
        // すべて選択のお気に入りから削除を登録に変更
        $doc['.collect-processing']->removeClass('fav')->addClass('history');
        $doc['.btn-delete']->after('<li class="btn-fav"><a href="#">お気に入りに登録</a></li>')->remove();
