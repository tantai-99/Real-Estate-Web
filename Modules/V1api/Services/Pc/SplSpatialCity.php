...
class SplSpatialCity extends Services\AbstractElementService
{
			...
			Datas $datas)
	{
		...
		$doc = $this->getTemplateDoc("/city/content_map.tpl");
        ...
        if ($canSpatialSearch && $isOnePref) {
            $hasTab = true;
            $liElem = "<li class='active spatial'><a href='/{$specialRow->filename}/${ken_ct}/map.html'>地図から探す</a></li>";
            $doc["div.element-tab-search ul"]->append($liElem);
        }
