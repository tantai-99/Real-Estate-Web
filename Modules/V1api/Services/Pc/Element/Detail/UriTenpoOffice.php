...
//         $tuboTxt = $this->getVal('tochi_shikichi_ms', $dispModel) . '／' . $this->getVal('tsubo_tanka_manen', $dispModel);
    ...
    private function createSetsubiIcon($shumoku, $mainInfoElem, $dispModel)
    {
    	...
    	if ($shumoku == Services\ServiceUtils::TYPE_URI_TENPO) {
