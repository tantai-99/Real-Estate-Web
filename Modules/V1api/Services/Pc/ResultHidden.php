...
class ResultHidden extends Services\AbstractElementService
{
...
//         $searchAreaElem = $ekiMaker->createElement($ekiWithEnsen, $type_ct, $ken_ct, false);
            ...
            Datas $datas)
    {
        ...
        $searchAreaElem = $cityMaker->createElement($shikugunWithLocateCd, $type_ct, $ken_ct, true, $settingObject->area_search_filter->canChosonSearch());
        ...
        Datas $datas)
    {
        ...
        $searchAreaElem = $maker->createElement($datas->getChosonList(), $type_ct, $ken_ct, true, $pNames->getShikuguns());
