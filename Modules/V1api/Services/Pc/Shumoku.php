...
class Shumoku extends Services\AbstractElementService
{
			...
			Datas $datas)
    {
        ...
        $doc = $this->getTemplateDoc("/shumoku/content.tpl");
        ...
        {
            $doc["div.elemnet-kind-rent"]->remove();

            // 親要素のwrapを削除
            $doc["div.element-search-kind"]->contentsUnwrap();
        }
        else
        {
        ...
        {
            $doc["div.elemnet-kind-buy"]->remove();
        ...
        $SEOMaker->shumoku($doc, $params, $settings, $datas);
