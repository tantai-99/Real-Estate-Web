...
<div class="main-contents">
	...
	<div class="main-contents-body">
		...
		<form action="/admin/company/other-estate-tag/company_id/{{$view->params['company_id']}}" method="post" name="form" enctype="multipart/form-data">
			@csrf
			<div class="section">
				...
				<div class="m-tab">
					...
					<a class="is-active">その他タグ（物件問い合わせ）</a>
				...
				<?php $tag_title = array(
					'above_close_head_tag_residential_rental_thanks' => '居住用賃貸物件フォーム(サンクスページ)',
					'above_close_head_tag_business_rental_thanks'    => '事業用賃貸物件フォーム(サンクスページ)',
					'above_close_head_tag_residential_sale_thanks'   => '居住用売買物件フォーム(サンクスページ)',
					'above_close_head_tag_business_sale_thanks'      => '事業用売買物件フォーム(サンクスページ)',
					'above_close_head_tag_residential_rental_input'  => '居住用賃貸物件フォーム(入力フォームページ)',
					'above_close_head_tag_business_rental_input'     => '事業用賃貸物件フォーム(入力フォームページ)',
					'above_close_head_tag_residential_sale_input'    => '居住用売買物件フォーム(入力フォームページ)',
					'above_close_head_tag_business_sale_input'       => '事業用売買物件フォーム(入力フォームページ)',
				); ?>
