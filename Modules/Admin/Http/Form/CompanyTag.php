...
class CompanyTag extends Form
{
	...
	public function init()
	{
		...
		$this->mainTag();
		$this->mainTag('contact', 'thanks');
		$this->mainTag('assess', 'thanks');
		$this->mainTag('request', 'thanks');
		$this->mainTag('contact', 'input');
		$this->mainTag('assess', 'input');
		$this->mainTag('request', 'input');
	}
	...
	private function mainTag($key1 = null, $key2 = null)
	{
		...
		// $element->addValidator(new StringLength(array('max' => 1000, 'messages' => '1000文字で入力してください')));
