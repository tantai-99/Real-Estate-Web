...
namespace App\Repositories\EstateRequestTag;
...
class EstateRequestTagRepository extends BaseRepository implements EstateRequestTagRepositoryInterface
{
    public function getModel()
    {
        return \App\Models\EstateRequestTag::class;
    }

    protected $_name = 'estate_request_tag';
